...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 2856;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 2956;
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntentIncrementWaterCount = PendingIntent.getService(
                context,
                ACTION_DRINK_PENDING_INTENT_ID,
                intentIncrementWaterCount,
                PendingIntent.FLAG_CANCEL_CURRENT);

        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action actionIncrementWaterCount =
                new NotificationCompat.Action(
                        R.drawable.ic_local_drink_black_24px,
                        "I DID IT!",
                        pendingIntentIncrementWaterCount);

        //      COMPLETED (16) Return the action
        return actionIncrementWaterCount;
    }
