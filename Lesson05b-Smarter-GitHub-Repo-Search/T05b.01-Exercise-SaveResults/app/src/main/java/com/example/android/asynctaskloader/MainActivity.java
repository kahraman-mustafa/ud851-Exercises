...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_QUERY_URL = "queryUrl";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String SEARCH_RESULT_RAW_JSON = "rawJSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(SEARCH_QUERY_URL)) {
                String searchQueryUrl = savedInstanceState.getString(SEARCH_QUERY_URL);
                mUrlDisplayTextView.setText(searchQueryUrl);
            }

            if(savedInstanceState.containsKey(SEARCH_RESULT_RAW_JSON)) {
                String searchResultJSON = savedInstanceState.getString(SEARCH_RESULT_RAW_JSON);
                mSearchResultsTextView.setText(searchResultJSON);
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String searchQueryUrl = mUrlDisplayTextView.getText().toString();
        outState.putString(SEARCH_QUERY_URL, searchQueryUrl);

        String searchResultsJSON = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULT_RAW_JSON, searchResultsJSON);
    }
